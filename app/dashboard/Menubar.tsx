  ...
  return (
    <div className='relative space-y-5'>
      <div className='flex justify-end w-full '>
        ...
        {/* <div className='absolute z-50 bg-red-500 left-1/2 w-96 h-96'>Hello</div> */}
      </div>
      <div className='flex items-center px-10 py-2 space-x-4 bg-gray-200'>
        <div className='relative inline-block text-left'>
          ...
          <div
            ...
            className='absolute left-0 z-50 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5'
            role='menu'
      ...
      >
        ...
        <button
          ...
          className={
            editor.isActive('bulletList') ? 'is-active-editor-btn' : ''
          }
        >
          <FaListUl />
        </button>
        <button
          ...
          className={
            editor.isActive('orderedList') ? 'is-active-editor-btn' : ''
          }
        >
          <FaListOl />
        </button>
        ...
        <button
          ...
          className={
            editor.isActive('blockquote') ? 'is-active-editor-btn' : ''
          }
        >
          <FaQuoteLeft />
        </button>
